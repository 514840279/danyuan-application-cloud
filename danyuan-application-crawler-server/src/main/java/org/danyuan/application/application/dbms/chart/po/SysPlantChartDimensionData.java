package org.danyuan.application.application.dbms.chart.po;
 ...
 */
@Entity
@Table(name = "sys_plant_chart_dimension_data")
@NamedQuery(name = "SysPlantChartDimensionData.findAll", query = "SELECT s FROM SysPlantChartDimensionData s")
public class SysPlantChartDimensionData implements Serializable {
	...
	public SysPlantChartDimensionData() {
	}
