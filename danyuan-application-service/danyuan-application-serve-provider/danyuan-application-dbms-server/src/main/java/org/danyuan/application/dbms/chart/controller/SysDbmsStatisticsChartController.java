...
public class SysDbmsStatisticsChartController {
	...
	public Map<String, Object> build(@RequestBody SysDbmsChartDimension info) {
		...
		info = sysDbmsChartDimensionService.findOne(info);
		SysDbmsChartDimensionData sysDbmsChartDimensionData = new SysDbmsChartDimensionData();
		sysDbmsChartDimensionData.setDimeUuid(info.getUuid());
		List<SysDbmsChartDimensionData> list = sysDbmsChartDimensionDataService.findAll(sysDbmsChartDimensionData);
	 ...
	 * @throws
	 */
	private void buildMap(Map<String, Object> map, SysDbmsChartDimension info, List<SysDbmsChartDimensionData> list) {
	 ...
	 * @throws
	 */
	private void buildBarOrLine(Map<String, Object> map, SysDbmsChartDimension info, List<SysDbmsChartDimensionData> list) {
	 ...
	 * @throws
	 */
	private void buildPie(Map<String, Object> map, SysDbmsChartDimension info, List<SysDbmsChartDimensionData> list) {
