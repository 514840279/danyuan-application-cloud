...
import org.danyuan.application.dbms.chart.po.SysPlantChartDimension;
...
import org.danyuan.application.dbms.chart.service.SysPlantChartDimensionService;
...
public class SysPlantChartDimensionController {
	...
	public ModelAndView addBefor(HttpServletRequest request) {
		logger.info("addBefor", SysPlantChartDimensionController.class);
		ModelAndView view = new ModelAndView("plant/chart/add");
