...
*  技能ID ：
*  作    者 ： wang  
*  时    间 ： 2018年11月2日 上午6:21:50  
*  版    本 ： V1.0    
*/
@RestController
@RequestMapping("/sysCrawlerTaskErrInfo")
public class SysCrawlerTaskErrInfoController {
	...
	*/
	...
	public Page<SysCrawlerTaskErrInfo> page(@RequestBody Pagination<SysCrawlerTaskErrInfo> vo) {
		return sysCrawlerTaskErrInfoService.page(vo.getPageNumber(), vo.getPageSize(), vo.getInfo(), vo.getMap(), new Order(""));
	}
	...
	*/
	...
	public List<SysCrawlerTaskErrInfo> findAll(@RequestBody SysCrawlerTaskErrInfo info) {
		return sysCrawlerTaskErrInfoService.findAll(info);
	}
	...
	*/
	...
	public SysCrawlerTaskErrInfo findOne(@RequestBody SysCrawlerTaskErrInfo info) {
		return sysCrawlerTaskErrInfoService.findOne(info);
	}
	...
	*/
	@RequestMapping("/save")
	public String save(@RequestBody SysCrawlerTaskErrInfo info) {
		sysCrawlerTaskErrInfoService.save(info);
		return "1";
	}
	...
	*/
	...
	public String save(@RequestBody Pagination<SysCrawlerTaskErrInfo> vo) {
		sysCrawlerTaskErrInfoService.save(vo.getList());
		return "1";
	}
	...
	*/
	...
	public String delete(@RequestBody Pagination<SysCrawlerTaskErrInfo> vo) {
		sysCrawlerTaskErrInfoService.delete(vo.getList());
		return "1";
	}
	...
	*/
	...
	public String delete(@RequestBody SysCrawlerTaskErrInfo info) {
		sysCrawlerTaskErrInfoService.delete(info);
		return "1";
	}
	...
	*/
	...
	public String trunc() {
		sysCrawlerTaskErrInfoService.trunc();
		return "1";
	}
