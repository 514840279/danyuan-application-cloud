...
import org.danyuan.application.application.softm.roles.vo.MailVo;
import org.danyuan.application.application.softm.roles.vo.PhoneVo;
...
public class SimapleMailRegist {
	...
	public PhoneVo SendPhoneToCustom(@RequestBody PhoneVo vo) throws ClientException {
