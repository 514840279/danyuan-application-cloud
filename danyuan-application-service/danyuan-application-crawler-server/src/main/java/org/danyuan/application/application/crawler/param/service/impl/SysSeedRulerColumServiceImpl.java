package org.danyuan.application.application.crawler.param.service.impl;

import java.util.List;

import org.danyuan.application.application.crawler.param.dao.SysSeedRulerColumDao;
import org.danyuan.application.application.crawler.param.po.SysSeedRulerColumInfo;
import org.danyuan.application.application.crawler.param.service.SysSeedRulerColumService;
...
public class SysSeedRulerColumServiceImpl implements SysSeedRulerColumService {
	...
	public List<SysSeedRulerColumInfo> findAllByRulerUuid(String rulerUuid) {
		return sysSeedRulerColumDao.findAllByRulerUuid(rulerUuid);
	}
