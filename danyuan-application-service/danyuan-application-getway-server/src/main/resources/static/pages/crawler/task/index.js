...
$(function() {
	...
	$("#search_task_excuteFlag").select2({
	    tags: true,
	    placeholder: "状态",
	    data: [{id:'请选择',text:'请选择'},{id:'0',text:'停止'},{id:'1',text:'执行中'}]
	});
...
//        exportTypes:[ 'csv', 'txt', 'sql', 'doc', 'excel', 'xlsx', 'pdf'],  //导出文件类型
		...
		columns : [
			...
			{title : '任务启动时间',field : 'startTime',sortable : true,align : 'center',valign : 'middle',visible:false,formatter:dateTimeFormatter},
			{title : '最后一次执行时间',field : 'lastExcuteTime',align : 'center',sortable : true,valign : 'middle',formatter:dateTimeFormatter},
			...
			{title : '创建时间',field : 'createTime',align : 'center',sortable : true,valign : 'middle',formatter:dateTimeFormatter,visible:false},
			{title : '更新时间',field : 'updateTime',align : 'center',sortable : true,valign : 'middle',formatter:dateTimeFormatter,visible:false},
